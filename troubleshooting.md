...
>3tene はウェブカメラでのフェイストラッキングには対応していますが
>ビデオキャプチャデバイスには対応していません。
>Windows であればデバイスマネージャーでカメラを認識しているか確認してください。
...
>なお、[仮想ウェブカメラ](#VirtualWebCamera.md)を経由した映像キャプチャデバイスによる
>使用が推奨されます。
